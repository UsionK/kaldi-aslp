...
#ifndef ASLP_NNET_NNET_DEEP_FSMN_H_
#define ASLP_NNET_NNET_DEEP_FSMN_H_
 ...
 class DeepFsmn : public UpdatableComponent {
  public:
   ...
   void InitData(std::istream &is) {
     ...
     RandUniform2(0.0, range, &p_weight_);
  ...
  void GetGpuParams(std::vector<std::pair<BaseFloat *, int> > *params) {
    ...
    params->push_back(std::make_pair(p_weight_.Data(), p_weight_.NumRows() * p_weight_.Stride()));
